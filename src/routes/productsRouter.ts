...
//  POST (crear uno)
productsRouter.post('/', validationHandler(CreateProductDto), async (request : Request, response : Response, next : NextFunction)  => {
	try {
...
//  GET (traer todos)
productsRouter.get('/', async (request : Request , response : Response, next : NextFunction ) => {
	try {
...
productsRouter.get('/:id', async (request : Request, response : Response, next : NextFunction) => {
	try {
...
productsRouter.patch('/:id', validationHandler(UpdateProductDto), async (request : Request, response : Response, next : NextFunction)  => {
	try {
		const id : string = request.params.id;
...
productsRouter.put('/:id', validationHandler(CreateProductDto), async (request : Request, response : Response, next : NextFunction)  => {
	try {
		const id : string = request.params.id;
		const body : CreateProductDto = request.body;
...
productsRouter.delete('/:id', async (request : Request, response : Response, next : NextFunction)  => {
	try {
