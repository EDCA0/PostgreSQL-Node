...
export class OrderProductService {
	...
	async find(
		...
		if (sortByColumn && sortDirection) {
			...
			if (
				allowedSortColumns.includes(sortByColumn) &&
				...
				console.warn(
					`!!!!!!Parámetros de ordenamiento inválidos: columna '${sortByColumn}' o dirección '${sortDirection}'. Se ignorará el ordenamiento.!!!!!!`,
				);
