...
export class ProductService {
	...
	async updatePatch (id: string, body : UpdateProductInput)  : Promise<IProduct | undefined> {
	...
	async updatePut (id: string, body : UpdateProductInput)  : Promise<IProduct | undefined> {
		const index = this.products.findIndex(item => item.id === id);
